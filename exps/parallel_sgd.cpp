...
main(int argc, char **argv)
{
    ...
    uint N_LABELS    = 10;
    uint N_BATCHES   = int(FASHION_MNIST_TRAIN/SBATCH_SIZE);

    /* Loading dataset */
    vector<DataMat> *train_images, *train_labels, *test_images, *test_labels;

    if (pid == MASTER_RANK) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
        train_images = load_images(FASHION_MNIST_TRAIN, SBATCH_SIZE);
        train_labels = load_labels(FASHION_MNIST_TRAIN, SBATCH_SIZE);   

        /* Test set */
        test_images = load_images(FASHION_MNIST_TEST, SBATCH_SIZE);
        test_labels = load_labels(FASHION_MNIST_TEST, SBATCH_SIZE);     
    } else {
